...
public class Main {
	...
	/**
	 * This method allows the player to choose the plant they wish to use in the game.
	 * @param choice (String), the players choice of plant.
	 * @return A plant, the plant of the player's choice otherwise null.
	 */
	...
	private static void prepareNewTurn() {
		for (Plant plant : Level.allPlants) // This function just decreases the wait time for all plant types. Does this
			...
			plant.newTurn();
		for (GridObject plant : Board.gridObjects) { // Possibility to extend this to other objects and call a method they
